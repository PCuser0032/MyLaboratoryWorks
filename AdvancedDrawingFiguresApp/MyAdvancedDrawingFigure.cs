...
namespace GeometricFigures
{
    ...
    public class Circle : MyGeometricFigure
    {
        ...
        {
            gr.DrawEllipse(new Pen(Color), (float)Position.X, (float)Position.Y, (float)(2.0 * Radius), (float)(2.0 * Radius));
    ...
    public class Triangle : MyGeometricFigure
    {
        ...
        public override void DrawFigure(Graphics gr)
        {
            //gr.DrawEllipse(new Pen(Color), Position.X, Position.Y, (int)GetCircumscribedCircleRadius(), (int)GetCircumscribedCircleRadius());
            gr.DrawEllipse(new Pen(Color), (float)Position.X, (float)Position.Y, (float)GetCircumscribedCircleRadius(), (float)GetCircumscribedCircleRadius());
